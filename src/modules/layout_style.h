...
#define DESIGN_FONT_COMPACT_PRIMARY_TEXT FONT_KEY_GOTHIC_18
#define DESIGN_FONT_COMPACT_DATE_TEXT FONT_KEY_GOTHIC_18_BOLD

#define DESIGN_FONT_TIME_TEXT FONT_KEY_ROBOTO_BOLD_SUBSET_49
#define DESIGN_FONT_PRIMARY_TEXT FONT_KEY_GOTHIC_28
#define DESIGN_FONT_DATE_TEXT FONT_KEY_GOTHIC_28_BOLD
