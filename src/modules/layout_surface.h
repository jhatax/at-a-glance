...
enum {
  ...
  DESIGN_FULL_TIME_TEXT_HEIGHT = HELPER_IF_ELSE(IS_GABBRO, 72, 60),
  DESIGN_FULL_DATA_TEXT_HEIGHT = 28,
  DESIGN_FULL_CLIMATE_TEXT_WIDTH = 60,  // this isn't used by the architect today
#ifdef PBL_HEALTH
...
enum {
  ...
  DESIGN_COMPACT_CLIMATE_TEXT_WIDTH = 44,  // this isn't used by the architect today
#ifdef PBL_HEALTH
