...
void parse_int_tuple(DictionaryIterator* iter,
  ...
  int* value);
void parse_settings_data(DictionaryIterator* iter, WatchfaceEventData* data);
void parse_weather_data(DictionaryIterator* iter, WatchfaceEventData* data);
#ifdef PBL_HEALTH
void parse_health_settings_data(DictionaryIterator* iter, WatchfaceEventData* data);
void parse_oneshot_health_data(DictionaryIterator* iter, WatchfaceEventData* data);
#endif
